function goodVsEvil(good, evil){
    let goodTeam = good.split(' ');
    let evilTeam = evil.split(' ');
    totalGood = 1*Number(goodTeam[0])+2*Number(goodTeam[1])+3*Number(goodTeam[2])+3*Number(goodTeam[3])+4*Number(goodTeam[4])+10*Number(goodTeam[5]);
    totalEvil = 1*Number(evilTeam[0])+2*Number(evilTeam[1])+2*Number(evilTeam[2])+2*Number(evilTeam[3])+3*Number(evilTeam[4])+5*Number(evilTeam[5]) + 10*Number(evilTeam[6]);
